...
const Note = ({ japanese, furigana, translation }: NoteProps) => {
  ...
  return (
    ...
    >
      ...
      {isHovered && (
        <div className="absolute z-10 p-4 bg-neutral-800 dark:bg-neutral-700 underline-offset-4 decoration-white text-white rounded-lg shadow-lg -translate-x-1/4 left-1/2 bottom-full mb-2 whitespace-nowrap">
